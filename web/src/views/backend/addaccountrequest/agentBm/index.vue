<template>
    <div class="default-main ba-table-box">
        ...
        <TableHeader
            ...
            :quick-search-placeholder="t('Quick search placeholder', { fields: t('addaccountrequest.agentBm.quick Search Fields') })"
        >
        ...
        <template #default  >
            <el-button v-auth="'dispose'" v-blur :disabled="baTable.table.selection!.length > 0 ? false:true" class="table-header-operate" type="success" @click="accountAuditFn(2)">
                ...
                <span class="table-header-operate-text">{{t('addaccountrequest.agentBm.dispose_type')}}</span>
            </el-button>
        </template>
