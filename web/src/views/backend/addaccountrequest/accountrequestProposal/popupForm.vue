        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    ...
                    <FormItem :label="t('addaccountrequest.accountrequestProposal.status')" type="select" v-model="baTable.form.items!.status" prop="status" :input-attr="{ content: { 0 : '未分配',1 : '已分配',2 : '不可分配'} }" :placeholder="t('Please select field', { field: t('addaccountrequest.accountrequestProposal.status') })" />
