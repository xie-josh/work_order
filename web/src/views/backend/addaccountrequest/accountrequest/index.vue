...
const baTable = new baTableClass(
    new baTableApi('/admin/addaccountrequest.Accountrequest/'),
    {
        ...
        column: [
            ...
            { label: t('addaccountrequest.accountrequest.create_time'), prop: 'create_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
            { label: t('addaccountrequest.accountrequest.update_time'), prop: 'update_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
