...
const baTable = new baTableClass(
    new baTableApi('/admin/auth.AdminMoneyLog/'),
    {
        ...
        column: [
            ...
            { label: t('auth.adminMoneyLog.money'), prop: 'money', align: 'center', operatorPlaceholder: t('Fuzzy query'), operator: 'LIKE', sortable: false },
            ...
            { label: t('auth.adminMoneyLog.create_time'), prop: 'create_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
            { label: t('auth.adminMoneyLog.update_time'), prop: 'update_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
