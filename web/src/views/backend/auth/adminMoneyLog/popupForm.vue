...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    admin_id: [buildValidatorData({ name: 'required', title: t('auth.adminMoneyLog.admin_id') })],
    money: [buildValidatorData({ name: 'required', title: t('auth.adminMoneyLog.money') })],
    create_time: [buildValidatorData({ name: 'date', title: t('auth.adminMoneyLog.create_time') })],
    update_time: [buildValidatorData({ name: 'date', title: t('auth.adminMoneyLog.update_time') })],
})
</script>
