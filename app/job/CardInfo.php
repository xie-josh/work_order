...
class CardInfo
{
    ...
    public function lampayCardInfo($param)
    {
        $cardsId = $param['id'];
        $accountId = $param['account_id'];
        $cardId = $param['card_id'];
    ...
    public function airwallexCardInfo($param)
    {
        $cardsId = $param['id'];
        $accountId = $param['account_id'];
        $cardId = $param['card_id'];
        ...
        try {
            ...
            $data = [
                ...
                'card_status'=>$result['cardStatus'],
                'card_type'=>$result['cardType'],
                'created_at'=>date('Y-m-d H:i:s',strtotime($result['createdAt'])),
                'member_id'=>$result['memberId'],
                'matrix_account'=>$result['matrixAccount'],
                'email'=>$result['email'],
                'expiration_date'=>$result['expirationDate'],
    ...
    public function slashCardInfo($param)
    {
        $cardsId = $param['id'];
        $accountId = $param['account_id'];
        $cardId = $param['card_id'];
