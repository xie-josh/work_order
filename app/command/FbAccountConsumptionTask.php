...
class FbAccountConsumptionTask extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        ->field('accountrequest_proposal.id,accountrequest_proposal.account_id,fb_bm_token.business_id,fb_bm_token.token,fb_bm_token.type,fb_bm_token.personalbm_token_ids,accountrequest_proposal.currency')
